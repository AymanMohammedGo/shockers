...
import { getContact, getJobOffers } from "../../../../../utils/DecaApi";
          ...
          {nav.map((item, index) => (
            <li
              ...
              className={`px-4 py-2 mx-3 mb-3 lg:mb-0 cursor-pointer w-full ${
                sectionView === item.index && "bg-deca text-white rounded-lg"
              }`}
              onClick={() => {
        ...
        {sectionView === 0 && (
          <div className="flex flex-col justify-between md:flex-row mx-3 overflow-hidden">
            <div className="w-full md:w-[60%] xl:w-[50%] p-2 m-auto ">
              ...
              <Button className="bg-deca hover:bg-shockersAEC text-white w-full text-lg rounded-lg">
                {ContactNames.SUBMIT}
              </Button>
            </div>
          </div>
                ...
                >
                  {jobOffers.length > 0 ? (
                    jobOffers.map((item, index) => (
                      <SwiperSlide
                        key={index}
                        className="!flex justify-center items-center bg-deca text-white text-xl text-center rounded-lg"
                      >
                        {item.attributes?.title}
                      </SwiperSlide>
                    ))
                  ) : (
                    <SwiperSlide className="!flex justify-center items-center bg-deca text-white text-xl text-center rounded-lg">
