          ...
          {sectionView === 0 && (
            ...
            >
              ...
              >
                ...
                />
                <Button className="bg-shockersAEC hover:bg-shockersAECYellow text-white w-full text-base rounded-lg">
                ...
                <div className="mb-8 mt-4 w-full h-[250px] ">
                  ...
                  >
                    {jobOffers.length > 0 ? (
                      ...
                      <SwiperSlide className="!flex justify-center items-center bg-shockersAEC text-white text-lg text-center rounded-lg">
