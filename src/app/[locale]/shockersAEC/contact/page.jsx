        ...
        <ul className="flex flex-col md:flex-row items-center text-lg  text-center w-full px-4 mb-0 md:mb-10 ">
          <li
            className={`px-4 py-2 mx-3 mb-3 lg:mb-0 cursor-pointer w-full ${
              sectionView === 0 && "bg-shockersAEC text-white rounded-lg"
            }`}
            onClick={() => {
              setSectionView(0);
            }}
          ...
          <li
            className={`px-4 py-2 mx-3 mb-3 lg:mb-0 cursor-pointer w-full ${
              sectionView === 1 && "bg-shockersAEC text-white rounded-lg"
            }`}
            onClick={() => {
              setSectionView(1);
            }}
          ...
          <li
            className={`px-4 py-2 mx-3 mb-3 lg:mb-0 cursor-pointer w-full ${
              sectionView === 2 && "bg-shockersAEC text-white rounded-lg"
            }`}
            onClick={() => {
              setSectionView(2);
            }}
          ...
          <div className="flex flex-col justify-between md:flex-row mx-3 overflow-hidden">
            <div className="w-full md:w-[60%] xl:w-[50%] p-2 ">
              ...
              <div className="mb-4">
                ...
                <Textarea
                  id="INQUIRY"
                  placeholder="To inquire about Shockers AEC's services, products, or to request
additional information, kindly submit your query here."
                          ...
                          footerNames?.DetailedAddress.split("rd").map(
                            (part, index) => (
                              <>
                                {part}
                                {index <
                                  footerNames?.DetailedAddress.split("rd")
                                    .length -
          ...
          <div className="flex flex-col justify-between md:flex-row mx-3 overflow-hidden">
            <div className="w-full md:w-[60%] xl:w-[50%] p-2 ">
              <h1 className="text-shockersAEC text-xl  border-b-[1px] border-shockersAEC/20 mb-5 pb-5 lg:mb-10 lg:pb-10 font-medium ">
                Subscribe to receive regular updates on Shockers AEC is
                innovative projects and exciting news.
              </h1>
              <div className="mb-4">
                <Label
                  htmlFor="FULLNAME"
        ...
        {sectionView === 2 && (
          <div className="flex flex-col justify-between md:flex-row mx-3 overflow-hidden">
            <div className="w-full md:w-[60%] xl:w-[50%] p-2 ">
              <h1 className="text-shockersAEC text-xl  border-b-[1px] border-shockersAEC/20 mb-5 pb-5 lg:mb-10 lg:pb-10 font-medium ">
                We are always on the lookout for exceptional talent. Submit your
                CV and portfolio here to be considered for current or future
                positions.
              </h1>
              <div className="mb-4">
                <Label
              ...
              <div className="mb-4">
                <Label htmlFor="cv" className="mb-3 text-lg text-shockersAEC">
                  CV & PORTFOLIO
                </Label>
                <Input
                  id="cv"
              ...
              <div className="mb-4">
                <Textarea
                  id="Notes"
                  placeholder="please let us know if you have any additional
information.."
                  className="text-base bg-transparent border-shockersAEC border-[1px] my-2 cancelEffect"
                  rows={2}
                />
