          ...
          {sectionView === 0 && (
            ...
            >
              ...
              >
                ...
                />
                <Button className="bg-shocky hover:bg-shockersAECYellow text-white w-full text-lg rounded-lg">
                  {ContactNames.SUBMIT}
                </Button>
              </form>
            </motion.div>
                  ...
                  >
                    {jobOffers.length > 0 ? (
                      jobOffers.map((item, index) => (
                        <SwiperSlide
                          key={index}
                          className="!flex justify-center items-center bg-shocky text-white text-xl text-center rounded-lg"
                        >
                          {item.attributes?.title}
                        </SwiperSlide>
                      ))
                    ) : (
                      <SwiperSlide className="!flex justify-center items-center bg-shocky text-white text-xl text-center rounded-lg">
