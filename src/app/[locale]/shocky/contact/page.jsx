...
import { getContact, getJobOffers } from "../../../../../utils/ShockyApi";
        ...
        <section className="min-h-screen max-w-screen-xl  mx-auto mt-[100px]  z-10 relative flex   flex-col ">
          <ul className="flex flex-col md:flex-row items-center text-base  text-center w-full px-4 mb-0 md:mb-10 ">
            {nav.map((item, index) => (
              <li
                key={index}
                className={`px-4 py-2 mx-3 mb-3 lg:mb-0 cursor-pointer rounded-lg flex items-center lg:justify-center hover:bg-shocky hover:text-white transition-all w-full ${
                  sectionView === item.index && "bg-shocky text-white "
                }`}
                onClick={() => {
          ...
          {sectionView === 0 && (
            ...
            >
              ...
              >
                ...
                />
                <Button className="bg-shocky hover:bg-shockyRed text-white w-full text-base rounded-lg">
              ...
              >
                <div className="text-shockersAEC text-lg  border-b-[1px] border-shockersAEC/20 mb-3 pb-3 lg:mb-5 lg:pb-5 font-medium ">
                  {ContactNames.JOBAPPLICATION_Title && (
                    <p className="bg-shocky text-white px-2 py-1">
                      {ContactNames.JOBAPPLICATION_Title}
                    </p>
                  )}
                  ...
                  >
                    {jobOffers.length > 0 ? (
                      jobOffers.map((item, index) => (
                        <SwiperSlide
                          key={index}
                          className="!flex justify-center items-center bg-shocky text-white text-lg text-center rounded-lg"
                        >
                          {item.title}
                        </SwiperSlide>
                      ))
                    ) : (
                      <SwiperSlide className="!flex justify-center items-center bg-shocky text-white text-lg text-center rounded-lg">
