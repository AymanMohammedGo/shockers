...
import YMar_json from "/public/Motion/shocky outline.json";
          ...
          <div className="flex flex-col justify-center items-center h-full max-w-screen-xl text-center m-auto">
            <div className="bg-shocky m-3 px-5 py-20 lg:p-20 rounded-2xl text-white">
              ...
              <Link href="/ymarketing/contact">
                <button className="w-fit text-xl lg:text-2xl xl:text-3xl font-medium bg-shockyRed text-white rounded-xl hover:bg-white hover:text-shockyRed  py-3 px-10">
