          ...
          {sectionView === 0 && (
            ...
            >
              ...
              >
                ...
                />
                <Button className="bg-yard hover:bg-shockersAEC text-white w-full text-lg rounded-lg">
                  {ContactNames.SUBMIT}
                </Button>
              </form>
            </motion.div>
                  ...
                  >
                    {jobOffers.length > 0 ? (
                      jobOffers.map((item, index) => (
                        <SwiperSlide
                          key={index}
                          className="!flex justify-center items-center bg-yard text-white text-xl text-center rounded-lg"
                        >
                          {item.attributes?.title}
                        </SwiperSlide>
                      ))
                    ) : (
                      <SwiperSlide className="!flex justify-center items-center bg-yard text-white text-xl text-center rounded-lg">
