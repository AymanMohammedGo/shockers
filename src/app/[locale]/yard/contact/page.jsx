        ...
        <section className="min-h-screen max-w-screen-xl  mx-auto mt-[100px]  z-10 relative flex   flex-col ">
          <ul className="flex flex-col md:flex-row items-center text-base  text-center w-full px-4 mb-0 md:mb-10 ">
            {nav.map((item, index) => (
              <li
                key={index}
                className={`px-4 py-2 mx-3 mb-3 lg:mb-0 cursor-pointer w-full rounded-lg flex items-center lg:justify-center hover:bg-yard hover:text-white ${
                  sectionView === item.index && "bg-yard text-white "
                }`}
                onClick={() => {
          ...
          {sectionView === 0 && (
            ...
            >
              ...
              >
                ...
                />
                <Button className="bg-yard hover:bg-shockersAEC text-white w-full text-base rounded-lg">
              ...
              >
                <div className="text-shockersAEC text-lg  border-b-[1px] border-shockersAEC/20 mb-3 pb-3 lg:mb-5 lg:pb-5 font-medium ">
                  {ContactNames.JOBAPPLICATION_Title && (
                    <p className="bg-yard text-white px-2 py-1">
                      {ContactNames.JOBAPPLICATION_Title}
                    </p>
                  )}
                  ...
                  >
                    {jobOffers.length > 0 ? (
                      jobOffers.map((item, index) => (
                        <SwiperSlide
                          key={index}
                          className="!flex justify-center items-center bg-yard text-white text-lg text-center rounded-lg"
                        >
                          {item.attributes?.title}
                        </SwiperSlide>
                      ))
                    ) : (
                      <SwiperSlide className="!flex justify-center items-center bg-yard text-white text-lg text-center rounded-lg">
