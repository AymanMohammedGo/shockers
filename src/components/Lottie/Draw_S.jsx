...
const LottieAnimation = ({ animationData, speed, delay = 0 }) => {
  ...
  return (
    <div
      ...
      className="fixed top-[54%] left-1/2 transform -translate-x-1/2 -translate-y-1/2  w-[1350px] lg:w-[1400px] xxl:w-[1600px] xxxl:w-[2000px] xlgl:w-[2500px] xlxl:w-[3000px]  object-cover z-0"
